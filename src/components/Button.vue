...
const buildClasses = computed(() => {
	const classes = [
		'btn active:border-b-2 disabled:(!bg-slate-100 !border-slate-200 !text-slate-400) dark:disabled:(!bg-neutral-700 !border-neutral-600 !text-neutral-500) duration-100 group border-2 border-b-4 overflow-hidden relative whitespace-nowrap',
	]
